...
const FarmerStatementCapture = ({
  ...
  const defaultImageUrl = `https://sfamsserver.in/uploads/docs/${farmervid}`;
  console.log("video ", farmervid);
  return (
    <StatementCaptureContainer id="statementCaptureContainer">
      ...
      {capturedVideo ? (
        <FarmerStatementPreview>
          {/* Use source tag with type attribute */}
        ...
        <StatementPhotoText>
          ...
          <video
            ...
            src={defaultImageUrl}
          >
            <source src={defaultImageUrl} type="video/mp4" />
            Your browser does not support the video tag.
          </video>
        </StatementPhotoText>
      )}
